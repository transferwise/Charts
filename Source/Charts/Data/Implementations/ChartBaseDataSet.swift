...
open class ChartBaseDataSet: NSObject, IChartDataSet
{
    ...
    open var gradientEndColors = [NSUIColor]()
    ...
    open func gradientEndColorAtIndex(index: Int) -> NSUIColor
    {
        var index = index
        if (index < 0)
        {
    ...
    open func resetColors()
    {
        ...
        gradientEndColors.removeAll(keepingCapacity: false)
    }
    ...
    open func addGradientEndColor(_ color: NSUIColor)
    {
    ...
    open func setGradientEndColor(_ color: NSUIColor)
    {
        gradientEndColors.removeAll(keepingCapacity: false)
        gradientEndColors.append(color)
    }
    ...
    open func setGradientEndColor(color: NSUIColor, alpha: CGFloat)
    {
        setGradientEndColor(color.withAlphaComponent(alpha))
    }
